  ...
  de: {
    ...
    pillars: [
      ...
      },
      {
        ...
        desc: "Beratung, Architektur, Implementierung und Migration — mit besonderer Tiefe im Datenbankumfeld, wo Standardlösungen an ihre Grenzen stoßen.",
        badge: "Spezialisierte Expertise",
        icon: "⚙️",
      },
      {
        num: "03",
        title: "Managed Services",
        desc: "Laufender Betrieb, Monitoring, Wartung und Lizenzmanagement — damit sich Ihr Team auf das Kerngeschäft konzentrieren kann, nicht auf den IT-Betrieb.",
        badge: "Verlässlicher Betrieb",
        icon: "🔄",
      },
    ],
    ...
    aiItems: [
      ...
      { icon: "🛡️", title: "AI Backup & Disaster Recovery", desc: "Zuverlässiger Schutz Ihrer AI-Daten und -Modelle." },
    ],
  },
  en: {
    tag: "Our Solutions",
    ...
    pillars: [
      ...
      },
      {
        ...
        desc: "Consulting, architecture, implementation and migration — with particular depth in the database space, where off-the-shelf solutions reach their limits.",
        badge: "Specialist Expertise",
        icon: "⚙️",
      },
      {
        num: "03",
        title: "Managed Services",
        desc: "Ongoing operations, monitoring, maintenance and licence management — so your team can focus on the core business, not IT operations.",
    ...
    aiItems: [
      ...
      { icon: "🛡️", title: "AI Backup & Disaster Recovery", desc: "Reliable protection for your AI data and models." },
    ],
  },
};
