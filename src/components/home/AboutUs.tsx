...
const content = {
  de: {
    ...
    usps: [
      { icon: "🗄️", title: "Datenbank-Know-how", desc: "Tiefe DB-Kompetenz ist im klassischen Systemhaus selten. Sie hilft uns, Ihre geschäftskritischen Workloads wirklich zu verstehen — von der Datenbank bis zur darunterliegenden Infrastruktur." },
  ...
  en: {
    ...
    usps: [
      { icon: "🗄️", title: "Database Know-how", desc: "Deep database expertise is rare among classic IT resellers. It helps us truly understand your business-critical workloads — from the database down to the underlying infrastructure." },
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {t.usps.map((usp) => (
              <div key={usp.title} className="bg-[#111827] border border-white/10 p-6 hover:border-[#c9a84c]/30 transition-colors group">
                {usp.badge ? (
                  <div className="inline-block bg-white rounded p-2 mb-3">
                    <img src={usp.badge} alt="Huawei Gold Partner" className="h-11 w-auto block" />
                  </div>
                ) : (
