    ...
    detail: {
      ...
      conditionalOptions: {
        ...
        cloud: [
          ...
          { value: "hybrid", icon: "☁️", label: "Hybrid Cloud", desc: "On-Prem & Cloud verbinden" },
        ...
        ai: [
          ...
          { value: "ai_dr", icon: "🛡️", label: "AI Backup & DR", desc: "Schutz von AI-Daten & Modellen" },
        ],
        database: [
          { value: "db_migration", icon: "🔄", label: "DB-Migration", desc: "Auf neue Plattform oder Version migrieren" },
          { value: "db_managed", icon: "⚙️", label: "Managed Database", desc: "Datenbankbetrieb auslagern" },
    ...
    detail: {
      ...
      conditionalOptions: {
        ...
        cloud: [
          ...
          { value: "hybrid", icon: "☁️", label: "Hybrid Cloud", desc: "Connect on-prem & cloud" },
        ...
        ai: [
          ...
          { value: "ai_dr", icon: "🛡️", label: "AI Backup & DR", desc: "Protect AI data & models" },
        ],
        database: [
          { value: "db_migration", icon: "🔄", label: "DB Migration", desc: "Migrate to a new platform or version" },
          { value: "db_managed", icon: "⚙️", label: "Managed Database", desc: "Outsource database operations" },
