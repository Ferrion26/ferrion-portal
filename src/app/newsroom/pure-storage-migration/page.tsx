...
export function generateMetadata({ searchParams }: SP) {
  return articleMetadata("pure-storage-migration", searchParams);
}
...
export default function PureStorageArticle({ searchParams }: SP) {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white">
      ...
      <ArticleJsonLd slug="pure-storage-migration" locale={locale} />
