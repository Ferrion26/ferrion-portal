...
export function generateMetadata({ searchParams }: SP) {
  return articleMetadata("citrix-netscaler-security-bulletin", searchParams);
}
...
export default function CitrixNetScalerArticle({ searchParams }: SP) {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white">
      ...
      <ArticleJsonLd slug="citrix-netscaler-security-bulletin" locale={locale} />
