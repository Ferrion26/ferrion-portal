...
export function generateMetadata({ searchParams }: SP) {
  return articleMetadata("private-ai-klinik", searchParams);
}
...
export default function PrivateAIArticle({ searchParams }: SP) {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white">
      ...
      <ArticleJsonLd slug="private-ai-klinik" locale={locale} />
