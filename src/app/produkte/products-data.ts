...
export const PRODUCTS: Product[] = [
  // ── Data Storage / AI Data Platform ────────────────────────────────
  {
    ...
    heroImage: "/images/Hero Visual/HWE_Storage.webp",
    icon: "🗄️",
  ...
  },
  {
    ...
    highlights: [
      { icon: "/Icons/wirtschaftlich.png", title: { de: "Wirtschaftlich skalieren", en: "Scale economically" }, desc: { de: "SSD-Tier für heiße Daten, HDD-Tier für Kapazität — automatisch verwaltet.", en: "SSD tier for hot data, HDD tier for capacity — automatically managed." } },
      { icon: "/Icons/fileservices.png", title: { de: "Für Fileservices geeignet", en: "Built for file services" }, desc: { de: "Skalierbares NAS für Abteilungslaufwerke, Home-Verzeichnisse und Archive.", en: "Scalable NAS for department shares, home directories and archives." } },
      { icon: "/Icons/migration.png", title: { de: "Nahtlose Migration", en: "Seamless migration" }, desc: { de: "Lässt sich mit bestehenden Dorado-Systemen im selben Verbund betreiben.", en: "Can run alongside existing Dorado systems in the same cluster." } },
    ],
    relatedArticleSlugs: [],
  },
  {
  ...
  },
  {
    ...
    heroImage: "/images/Hero Visual/Storage_Infrastruktur_Pure.webp",
    icon: "🌊",
    ...
    highlights: [
      { icon: "/Icons/Pure-Fusion.png", title: { de: "Pure//Fusion", en: "Pure//Fusion" }, desc: { de: "Non-disruptive Upgrades und Controller-Wechsel ohne Downtime im laufenden Betrieb.", en: "Non-disruptive upgrades and controller changes without downtime during operation." } },
      { icon: "/Icons/Everpure-Evergreen-Modell.png", title: { de: "Evergreen-Modell", en: "Evergreen model" }, desc: { de: "Kostenfreie Controller-Upgrades alle 3 Jahre — eliminiert zukünftige Migrationsrisiken.", en: "Free controller upgrades every 3 years — eliminates future migration risk." } },
      { icon: "/Icons/Hohe-Datenreduktion.png", title: { de: "Hohe Datenreduktion", en: "High data reduction" }, desc: { de: "Compression & Deduplizierung erreichen in der Praxis Reduktionsfaktoren von 4:1 und mehr.", en: "Compression & deduplication achieve real-world reduction ratios of 4:1 and higher." } },
    ],
  ...
  },
  {
    ...
    vendor: "Huawei",
    vendorLogo: "/logos/Huawei_Standard_logo.svg.png",
    heroImage: "/images/Hero Visual/DataLake01.webp",
    icon: "🌐",
    eyebrow: { de: "Produkt · Beispiel-Content", en: "Product · Example content" },
    name: "Data Lakes",
    tagline: {
  ...
  // ── Security ─────────────────────────────────────────────────────
  {
    ...
    heroImage: "/images/Hero Visual/Fudo_Visual_01.webp",
    icon: "🔑",
    ...
    highlights: [
      { icon: "/Icons/Volle_Sitzungstransparenz.png", title: { de: "Volle Sitzungstransparenz", en: "Full session visibility" }, desc: { de: "Jede privilegierte Sitzung wird aufgezeichnet und ist im Nachhinein auditierbar.", en: "Every privileged session is recorded and auditable after the fact." } },
      { icon: "/Icons/Just-in-Time-Zugriff.png", title: { de: "Just-in-Time-Zugriff", en: "Just-in-time access" }, desc: { de: "Zeitlich befristete Freigaben statt dauerhaft bestehender Admin-Rechte.", en: "Time-limited approvals instead of permanent admin rights." } },
      { icon: "/Icons/Anomalieerkennung.png", title: { de: "Anomalieerkennung", en: "Anomaly detection" }, desc: { de: "Erkennt untypisches Verhalten in privilegierten Sitzungen automatisch.", en: "Automatically detects unusual behaviour in privileged sessions." } },
    ],
    relatedArticleSlugs: [],
  },
  {
    ...
    categoryIds: ["security"],
    vendor: "Varonis",
    icon: "/logos/varonis-mark.png",
    heroImage: "/images/Hero Visual/Varonis_Visual_01.webp",
    eyebrow: { de: "Produkt · Beispiel-Content", en: "Product · Example content" },
    name: "Varonis",
    tagline: {
    ...
    highlights: [
      { icon: "/Icons/sensible_daten_finden.png", title: { de: "Sensible Daten finden", en: "Find sensitive data" }, desc: { de: "Automatische Klassifizierung über Fileserver, NAS und Cloud-Speicher hinweg.", en: "Automatic classification across file servers, NAS and cloud storage." } },
      { icon: "/Icons/clean_rights.png", title: { de: "Berechtigungen bereinigen", en: "Clean up permissions" }, desc: { de: "Zeigt überprivilegierte Zugriffe auf und hilft, sie systematisch abzubauen.", en: "Surfaces over-privileged access and helps reduce it systematically." } },
      { icon: "/Icons/verhalten_alarm.png", title: { de: "Verhaltensbasierte Alarme", en: "Behaviour-based alerts" }, desc: { de: "Erkennt untypische Datenzugriffe, etwa vor einem Ransomware-Vorfall.", en: "Detects unusual data access patterns, e.g. ahead of a ransomware incident." } },
    ],
    relatedArticleSlugs: [],
  },
  ...
  // ── Server Solutions ────────────────────────────────────────────
  {
    ...
    icon: "🖥",
    heroImage: "/images/Hero Visual/Dell_Visual_01.webp",
    eyebrow: { de: "Produkt · Beispiel-Content", en: "Product · Example content" },
    name: "Dell PowerEdge",
    tagline: {
    ...
    highlights: [
      { icon: "/Icons/Workload.png", title: { de: "Für jeden Workload", en: "For every workload" }, desc: { de: "Von virtualisierten Standard-Workloads bis zu GPU-dichten AI-Trainingsservern.", en: "From standard virtualised workloads to GPU-dense AI training servers." } },
      { icon: "/Icons/Lifecycle.png", title: { de: "Lebenszyklus-Management", en: "Lifecycle management" }, desc: { de: "Firmware-, BIOS- und Health-Management über den gesamten Betriebszeitraum.", en: "Firmware, BIOS and health management across the entire operating lifetime." } },
      { icon: "/Icons/integration.png", title: { de: "Integriert in Ihre Umgebung", en: "Integrated into your environment" }, desc: { de: "Passt in bestehende OceanStor- und FusionCompute-Landschaften.", en: "Fits into existing OceanStor and FusionCompute landscapes." } },
    ],
    relatedArticleSlugs: [],
  },
  ...
  // ── Backup & Recovery ───────────────────────────────────────────
  {
    ...
    highlights: [
      { icon: "/Icons/Physische-logische-Isolation.png", title: { de: "Physische & logische Isolation", en: "Physical & logical isolation" }, desc: { de: "Air-Gap-Kopien, die selbst bei kompromittierter Produktionsumgebung unerreichbar bleiben.", en: "Air-gapped copies that remain unreachable even if the production environment is compromised." } },
      { icon: "/Icons/kI-Erkennung.png", title: { de: "KI-gestützte Erkennung", en: "AI-based detection" }, desc: { de: "Erkennt Ransomware-Muster direkt in den Backup-Daten, nicht erst im Produktivsystem.", en: "Detects ransomware patterns directly in backup data, not only in the production system." } },
  ...
  },
  {
    ...
    heroImage: "/images/Hero Visual/Commvault_Visual_01.webp",
    icon: "☁️",
    ...
    highlights: [
      { icon: "/Icons/Plattform_Workload.png", title: { de: "Eine Plattform, alle Workloads", en: "One platform, every workload" }, desc: { de: "Physisch, virtuell, Cloud und SaaS über eine zentrale Konsole gesichert.", en: "Physical, virtual, cloud and SaaS protected through a single console." } },
      { icon: "/Icons/NIS2.png", title: { de: "NIS2-Nachweise", en: "NIS2 evidence" }, desc: { de: "Dokumentierte Restore-Tests und Reports, wie sie Audits verlangen.", en: "Documented restore tests and reports the way audits require them." } },
  ...
  // ── AI & Data Intelligence ──────────────────────────────────────
  {
    ...
    vendor: "Dell Technologies",
    vendorLogo: "/Icons/ai_gehirn_icon_sauber_transparent.png",
    heroImage: "/images/Hero Visual/Dell_AI_Visual.webp",
    icon: "🏭",
    eyebrow: { de: "Produkt · Beispiel-Content", en: "Product · Example content" },
  ...
  },
  {
    ...
    vendor: "Huawei",
    vendorLogo: "/logos/Huawei_Standard_logo.svg.png",
    heroImage: "/images/Hero Visual/HWE_AI_Appliance.webp",
    icon: "🤖",
    eyebrow: { de: "Produkt · Beispiel-Content", en: "Product · Example content" },
