...
export const PRODUCTS: Product[] = [
  // ── Data Storage / AI Data Platform ────────────────────────────────
  {
    ...
    vendor: "Huawei",
    vendorLogo: "/logos/huawei-mark.svg",
    icon: "🗄",
  ...
  },
  {
    ...
    tagline: {
      de: "Beispielhafter Platzhalter für eine zukünftige Storage-Partnerschaft.",
      en: "Example placeholder for a future storage partnership.",
    },
    intro: {
      de: "Beispiel-Content: Dieser Eintrag zeigt, wie sich ein zusätzlicher Storage-Hersteller in den Katalog einfügen lässt, ohne die Seitenstruktur zu verändern. Sobald reale Inhalte vorliegen, ersetzt dieser Text die Platzhalterangaben.",
      en: "Example content: This entry demonstrates how an additional storage vendor slots into the catalog without changing the page structure. Once real content is available, it will replace this placeholder copy.",
    },
    facts: [
    ...
    highlights: [
      { icon: "🌊", title: { de: "Performance", en: "Performance" }, desc: { de: "Wird ersetzt, sobald Produktdetails von Everpure vorliegen.", en: "Will be replaced once product details from Everpure are available." } },
      { icon: "🌊", title: { de: "Effizienz", en: "Efficiency" }, desc: { de: "Wird ersetzt, sobald Produktdetails von Everpure vorliegen.", en: "Will be replaced once product details from Everpure are available." } },
      { icon: "🌊", title: { de: "Integration", en: "Integration" }, desc: { de: "Wird ersetzt, sobald Produktdetails von Everpure vorliegen.", en: "Will be replaced once product details from Everpure are available." } },
    ],
    relatedArticleSlugs: [],
  },
  {
